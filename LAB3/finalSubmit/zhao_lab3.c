...
// ---------          -----------------------------------------------------------------------------------------------------------
            case RUN:
                ...
                {
                    R = 1; // we hard code a value for it moving right
                    
                    L=0, U=0, D=0; // hard code all other movement values to 0
                }
                else if (cur_LR <= 400)
                {
                    L = 1;
                ...
                /////////////////////////// Auto Movement Code /////////////////////////////////////////
                // based off the previous hard coded values of L,R,U,D, if they are stil the same, then it continues
...
// ---------          -----------------------------------------------------------------------------------------------------------
            case RESET:
                if (PORTG & 0x40) // waits for BTN 1 to be pressed to formally restart the game
                {
                    ...
                    L=0; // reinitializes L, R, U,D to 0 so it won't auto move the joystick
                    R=0;
                    U=0;
                    D=0;
